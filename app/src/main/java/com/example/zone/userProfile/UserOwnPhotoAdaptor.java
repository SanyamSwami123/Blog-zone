...
public class UserOwnPhotoAdaptor extends RecyclerView.Adapter<UserOwnPhotoAdaptor.ViewHolder> {

    private Context context;
    private List<Blog> blogList;

    public UserOwnPhotoAdaptor(Context context, List<Blog> blogList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new UserOwnPhotoAdaptor.ViewHolder(view, context);
    }

    @Override
    public void onBindViewHolder(@NonNull final UserOwnPhotoAdaptor.ViewHolder holder, final int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view, Context ctx) {
            ...
            button = (Button) view.findViewById(R.id.deleteitem);  //has to do delete
            userid = null;
